...
### 2. Manual Installation via CLI (For Developers)

If you want to install this app from source code using the Homey CLI:

1. Ensure you have [Node.js](https://nodejs.org/) installed.
2. Install the Homey CLI globally:
   ```bash
   npm install -g homey
   ```
3. Log in to the CLI with your Athom account:
   ```bash
   homey login
   ```
4. Clone this repository and navigate into the directory:
   ```bash
   git clone https://github.com/jfgosselin/homey-honeywell-thermostat.git
   cd homey-honeywell-thermostat
   ```
5. Install the required Node dependencies:
   ```bash
   npm install
   ```
6. Install the app onto your Homey:
   ```bash
   homey app install
   ```
